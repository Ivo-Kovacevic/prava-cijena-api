...
public interface IProductStoreRepository
{
    ...
    Task<List<ProductStore>> GetProductStoresByProductBarcodesBatchAsync(List<string> barcodes, Guid storeLocationId);
    ...
    Task BulkCreateAsync(List<ProductStore> productStores);
    Task BulkUpdateAsync(List<ProductStore> productStores);
}